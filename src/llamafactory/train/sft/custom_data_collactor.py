...
class DataCollatorForSeq2Seq:
    ...
    def get_features(self, features, return_tensors=None):
        ...
        # for non_labels_feature in non_labels_features:
        #     non_labels_feature.pop('images')
        #     non_labels_feature.pop('videoss')
    ...
    def __call__(self, features, return_tensors=None):
        ...
        for item in features:
            tmp = dict()
            tmp['input_ids'] = item['input_ids']
            tmp['labels'] = item['labels']
            tmp['attention_mask'] = item['attention_mask']
            tmp_feature.append(tmp)

        batch = self.get_features(tmp_feature, return_tensors=return_tensors)
        return batch
